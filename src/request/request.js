...
service.interceptors.response.use(
  response => {
    ...
    else Message.error('系统错误')
  }
)

export function request (requestParamObject) {
  if (requestParamObject.method === 'GET' && requestParamObject.data !== null) return getRequest(requestParamObject)
  return service({
...
function getRequest (requestParamObject) {
  return service.get(requestParamObject.url, {params: requestParamObject.data})
}
